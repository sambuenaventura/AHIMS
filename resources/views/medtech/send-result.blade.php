        ...
        <div class="card pe-0 mb-4 shadow-md">
            <div class="card-body m-2">
                ...
                <form action="{{ route('process.lab') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label">File Upload <span style="color: grey;">(Preferably upload images in PNG or JPG format. The maximum file size allowed is 12 MB.)</span></label>
