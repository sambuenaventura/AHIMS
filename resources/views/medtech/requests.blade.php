        ...
        <div class="card pe-0">
            <div class="card-body m-1">
                ...
                <ul class="nav nav-underline overflow-x-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request('status') === 'pending' ? 'active text-success' : 'text-secondary' }}" href="{{ route('medtech.requests', ['status' => 'pending']) }}">Pending Requests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request('status') === 'accepted' ? 'active text-success' : 'text-secondary' }}" href="{{ route('medtech.requests', ['status' => 'accepted']) }}">Accepted Requests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request('status') === 'completed' ? 'active text-success' : 'text-secondary' }}" href="{{ route('medtech.requests', ['status' => 'completed']) }}">Completed Requests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request('status') === 'declined' ? 'active text-success' : 'text-secondary' }}" href="{{ route('medtech.requests', ['status' => 'declined']) }}">Declined Requests</a>
                    </li>
