                                ...
                                <div class="card shadow">
                                    <div class="card-body m-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control my-3 py-3" placeholder="Address" aria-label="Address">
                                            
                                            <h6 class="text-success">ㅤ</h6>
                                            <input type="text" class="form-control py-3" placeholder="Relation to Patient" aria-label="Relation to Patient">

                                            <input type="text" class="form-control my-3 py-3 invisible" placeholder="Address" aria-label="Address">
                                            
                                            <h6 class="text-success">ㅤ</h6>
                                            <input type="text" class="form-control py-3" placeholder="Contact Number" aria-label="Contact Number">
