                        ...
                        <div id="patientOptions">
                            ...
                            <div class="flexi">
                                ...
                                <div class="box flex bg-custom-102">
                                    <img src="http://127.0.0.1:8000/storage/image/inpatient.png" alt="Inpatient Image" class="w-24 h-auto mr-4">
                                    <div class="flex flex-col justify-between">
                                      <h1 class="font-bold text-black">12</h1>
                                      <p>Inpatient</p>
                                    </div>
                                  </div>
                                  <div class="box flex bg-custom-102">
                                    <img src="http://127.0.0.1:8000/storage/image/outpatient.png" alt="Outpatient Image" class="w-24 h-auto mr-4">
                                    <div class="flex flex-col justify-between">
                                      <h1 class="font-bold text-black">12</h1>
                                      <p>Outpatient</p>
                                    </div>
