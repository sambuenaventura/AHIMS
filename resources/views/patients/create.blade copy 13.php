                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="buttons mt-4 float-end">
                                    ...
                                    <button type="button" class="btn btn-success ms-2" onclick="showConfirmationModal()">Submit</button>
                            ...
                            <div class="modal-body m-3">
                                <div class="modalContent">
                                    <h1 class="text-center text-success">
                                        <span class="material-symbols-outlined bg-success text-white rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 30px; height: 30px;">
                                            !
                                        </span>
                                    ...
                                    <div class="d-flex justify-content-evenly mt-5">
                                        ...
                                        <button type="submit" id="submitButton" class="btn btn-success ms-2">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modalContent">
                                    ...
                                    <div class="d-flex justify-content-evenly mt-5">
                                        <form class="row g-3" id="passwordForm">
                                            ...
                                            <div class="col-auto">
                                                <button type="button" class="btn btn-success mb-3" id="submitWithPassword">Enter</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
