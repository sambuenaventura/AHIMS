        ...
        <div class="card pe-0">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <a href="/edit-profile" class="btn btn-success ms-2 btn-custom-style btn-submit" style="width: auto;" type="submit">Edit Profile</a>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row g-3 align-items-end mb-3">
                                <div class="col">
                                    <div class="form-floating">
                                        <input type="text" disabled id="first_name" name="first_name" value="{{ auth()->user()->first_name }}" class="form-control bg-light" placeholder="First Name" aria-label="First Name">
                                ...
                                <div class="col">
                                    <div class="form-floating">
                                        <input type="text" disabled id="last_name" name="last_name" value="{{ auth()->user()->last_name }}" class="form-control bg-light" placeholder="Last Name" aria-label="Last Name">
                            ...
                            <div class="row g-3 align-items-end mb-3">
                                <div class="col">
                                    <div class="form-floating">
                                        <input type="text" disabled id="email" name="email" value="{{ auth()->user()->email }}" class="form-control bg-light" placeholder="HAU Email" aria-label="HAU Email">
                                ...
                                <div class="col">
                                    <div class="form-floating">
                                        <input type="text" disabled id="student_number" name="student_number" value="{{ auth()->user()->student_number }}" class="form-control bg-light" placeholder="Student Number" aria-label="Student Number">
