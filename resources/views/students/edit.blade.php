...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2x1">
    ...
    <section class="mt-10">
        <form action="/student/{{$student->id}}" method="POST" class="flex flex-col" enctype="multipart/form-data">
            ...
            <div class="flex justify-center item-center my-4"> @php $default_profile = "https://api.dicebear.com/7.x/initials/svg?seed=".$student->first_name."+".$student->last_name; @endphp
