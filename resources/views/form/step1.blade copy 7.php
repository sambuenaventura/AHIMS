                    ...
                    <div class="col-6">
                        ...
                        <div class="card my-2 checkboxes">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-check bg-light rounded-2 py-1">
                                            <input class="form-check-input mt-2" type="checkbox"                                 id="others_checkbox"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input type="text" class="form-control form-control-sm border-light rounded-2 ms-2" id="others_details" name="others_details" value="{{ optional($patient->medicalHistory)->others_details }}" disabled/>
                                            </div>
                        ...
                        <div class="card my-2 checkboxes">
                            <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="form-check bg-light rounded-2 py-1">
                                        <input class="form-check-input mt-2" type="checkbox"                                 id="family_others_checkbox"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <input type="text" class="form-control form-control-sm border-light rounded-2 ms-2" id="family_others_details" name="family_others_details" value="{{ optional($patient->medicalHistory)->family_others_details }}" disabled/>
                                        </div>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control rounded-4"
                                            placeholder="Dysmenorrhea" id="menstrual_dysmenorrhea" name="menstrual_dysmenorrhea" value="{{ optional($patient->medicalHistory)->menstrual_dysmenorrhea }}"/>
                    ...
                    <div class="col-6">
                        ...
                        <div class="card my-2 bg-light inputs">
                            <div class="card-body">
                                ...
                                <!-- Pregnancy -->
                                @foreach($patient->obstetricalHistories as $obstetricalHistory)
                                ...
                                <div class="card my-2 rounded-4">
                                    <div class="card-body bg-custom-103 rounded-4">
                                        ...
                                        <div class="d-flex pregnancy mb-2">
                                            <p>Delivered on</p>
                                            <input type="date" class="form-control rounded-4" placeholder="Date" id="obstetrical_pregnancy_delivered_on" name="obstetrical_pregnancy_delivered_on" value="{{ old('obstetrical_pregnancy_delivered_on', optional($patient->obstetricalHistory)->obstetrical_pregnancy_delivered_on) }}">
                                            @error('obstetrical_pregnancy_delivered_on')
                                            <p class="text-red-500 text-xs p-1">
                                                {{ $message }}
                                            </p>
                                            @enderror
                                            <p>to a</p>
                                            <select class="form-select" aria-label="Default select example" id="obstetrical_pregnancy_term_preterm" name="obstetrical_pregnancy_term_preterm">
                                                <option value="" selected disabled>term/preterm</option>
                                                <option value="term" {{ old('obstetrical_pregnancy_term_preterm', optional($patient->obstetricalHistory)->obstetrical_pregnancy_term_preterm) === 'term' ? 'selected' : '' }}>term</option>
                                                <option value="preterm" {{ old('obstetrical_pregnancy_term_preterm', optional($patient->obstetricalHistory)->obstetrical_pregnancy_term_preterm) === 'preterm' ? 'selected' : '' }}>preterm</option>
                                            </select>
                                            @error('obstetrical_pregnancy_term_preterm')
                                        ...
                                        <div class="d-flex pregnancy">
                                            <p>birth living</p>
                                            <select class="form-select" aria-label="Default select example" id="obstetrical_pregnancy_girl_boy" name="obstetrical_pregnancy_girl_boy">
                                                <option value="" selected disabled>girl/boy</option>
                                                <option value="girl" {{ old('obstetrical_pregnancy_girl_boy', optional($patient->obstetricalHistory)->obstetrical_pregnancy_girl_boy) === 'girl' ? 'selected' : '' }}>girl</option>
                                                <option value="boy" {{ old('obstetrical_pregnancy_girl_boy', optional($patient->obstetricalHistory)->obstetrical_pregnancy_girl_boy) === 'boy' ? 'selected' : '' }}>boy</option>
                                            </select>
                                            @error('obstetrical_pregnancy_girl_boy')
                                                <p class="text-red-500 text-xs p-1">{{ $message }}</p>
                                            @enderror
                                            <p>via</p>
                                            <select class="form-select" aria-label="Default select example" id="obstetrical_pregnancy_delivery_method" name="obstetrical_pregnancy_delivery_method">
                                                <option value="" selected disabled>nsd/cs</option>
                                                <option value="nsd" {{ old('obstetrical_pregnancy_delivery_method', optional($patient->obstetricalHistory)->obstetrical_pregnancy_delivery_method) === 'nsd' ? 'selected' : '' }}>nsd</option>
                                                <option value="cs" {{ old('obstetrical_pregnancy_delivery_method', optional($patient->obstetricalHistory)->obstetrical_pregnancy_delivery_method) === 'cs' ? 'selected' : '' }}>cs</option>
                                            </select>
                                            @error('obstetrical_pregnancy_delivery_method')
                                                <p class="text-red-500 text-xs p-1">{{ $message }}</p>
                                            @enderror
                                            <p>at a</p>
                                            <input type="text" class="form-control rounded-4" placeholder="Place of delivery" id="obstetrical_pregnancy_delivery_place" name="obstetrical_pregnancy_delivery_place" value="{{ old('obstetrical_pregnancy_delivery_place', optional($patient->obstetricalHistory)->obstetrical_pregnancy_delivery_place) }}">

                                                @error('obstetrical_pregnancy_delivery_place')
                                                    <p class="text-red-500 text-xs p-1">
                                                        {{$message}}
                                                    </p>
                                                @enderror  
