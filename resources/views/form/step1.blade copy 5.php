                ...
                <div class="row overflow-auto mx-4">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" id="floatingTextarea2" style="height: 400px">{{ optional($patient->medicalHistory)->complete_history }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="form-check bg-light rounded-2 py-1">
                                        ...
                                        />
                                        <div class="d-flex align-items-center">
                                            <label class="form-check-label" for="family_others_details">
                                                Others:
                                            </label>
                        ...
                        <div class="card my-2 bg-light inputs">
                            <div class="card-body">
                                ...
                                <div class="upload mt-3">
                                    <div class="card-body text-success py-4 border border-dotted rounded-4" style="border-width: 2px;">
