        ...
        <div class="card-body m-1">
            <div class="card pe-0">
                    ...
                    <div class="row mx-4 mt-5">
                        <h5 class="text-success">Medications, Treatment & etc.</h5>              
                        <div class="col">
                    ...
                    <div class="row mx-4">
                        <div class="col">
                            <div class="form-floating mt-2">
                                <input type="text" class="form-control rounded-4" placeholder="Medication" id="medication" name="medication" value="{{ optional($patient->MedicationRemarks->first())->medication }}" />
                        ...
                        <div class="col">
                            <div class="form-floating mt-2">
                                <input type="text" class="form-control rounded-4" placeholder="Dosage" id="medication_dosage" name="medication_dosage" value="{{ optional($patient->MedicationRemarks->first())->medication_dosage }}" />
                    ...
                    <div class="row mx-4">
                        ...
                        <div class="col">
                            <div class="form-floating mt-2">
                                <textarea class="form-control" id="current_medications" name="current_medications" style="height: 100px">{{ optional($patient->MedicationRemarks->first())->dietary_information }}</textarea>
