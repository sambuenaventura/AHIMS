    ...
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
      ...
      <div class="flex flex-shrink-0 transition-all">
        ...
        >
          ...
          <a href="#">
            <img
              class="w-10 h-auto"
              src="https://iili.io/J76M4Qj.th.png"
              alt="K-UI"
            />
          </a>
          ...
          <div class="relative flex items-center flex-shrink-0 p-2" x-data="{ isOpen: false }">
            ...
            >
              <img
                ...
                src="https://iili.io/J7s05YP.th.png "
                alt=""
              />
        ...
        <nav
          aria-label="Options"
          class="z-20 flex-col items-center flex-shrink-0 hidden w-16 py-4 bg-custom-50 border-r-2 border-indigo-100 shadow-md sm:flex rounded-tr-3xl rounded-br-3xl"
        >
          <!-- Logo -->
          ...
          <div class="relative flex items-center flex-shrink-0 p-2" x-data="{ isOpen: false }">
              ...
              <div
                ...
                x-ref="userMenu"
                tabindex="-1"
                class="absolute w-48 py-1 mt-2 origin-bottom-left bg-white rounded-md shadow-lg left-16 bottom-54 focus:outline-none"
                role="menu"
                aria-orientation="vertical"
                aria-label="user menu"
              >
      ...
      <div class="flex flex-col flex-1">
        ...
        {{-- <div class="flex flex-1">
          <!-- Main -->
          <main class="flex items-center bg-custom-700 justify-center flex-1 px-4 py-8">
