...
/* a:not(.btn-cancel, .d-flex, .flex-row, .gap-2, .text-success, .font-bold):hover {
    background-color: #3b7057 !important;
    color: white; 
} */
    ...
    <div class="position-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item mt-5">
              <a class="btn p-2 text-dark bg-opacity-25 material-symbols-outlined text-white" href="/profile" disabled>
                  <img src="https://api.dicebear.com/7.x/initials/svg?seed={{ substr(auth()->user()->first_name, 0, 1) . substr(auth()->user()->last_name, 0, 1) }}" alt="Avatar" width="60" height="60" style="border-radius: 50%;">
              </a>
          </li>
