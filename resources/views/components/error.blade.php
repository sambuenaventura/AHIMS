...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" 
  class="bg-red-400 font-bold fixed m-2 top-0 left-1/2 transform -translate-x-1/2 z-20 border-t-4 border-red-500 rounded-b text-white px-4 py-3 shadow-md" role="alert">
