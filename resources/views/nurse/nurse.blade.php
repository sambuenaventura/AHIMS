                                      ...
                                      <form id="acceptForm{{ $patient->patient_id }}" action="{{ route('archive.patient', ['patient_id' => $patient->patient_id]) }}" method="POST">
                                        @csrf
                                          {{-- <button type="button" class="" onclick="showConfirmationModal()"> --}}
                                            <button type="button" class="decline badge rounded-pill text-bg-danger d-inline-flex align-items-center gap-0.5 @if($patient->archived || ($patient->admission_type === 'Inpatient' && !$patient->discharge_date)) no-hover @endif" style="font-size: 1em;" onclick="showConfirmationModalForAccept({{ $patient->patient_id }})" @if($patient->archived || ($patient->admission_type === 'Inpatient' && !$patient->discharge_date)) disabled @endif>
                                                <span class="p-1 rounded">
                                                    ...
                                                    <div class="modal-body m-3">
                                                        <div class="modalContent">
                                                            ...
                                                            <div class="d-flex justify-content-evenly mt-5">
                                                                ...
                                                                <button type="button" class="btn btn-light ms-2 btn-custom-style btn-cancel cancel-btn" data-bs-dismiss="modal">Cancel</button>
