...
<header class="max-w-lg mx-auto">
    <a href="">
        <h1 class="text-4xl font-bold text-black text-center">Nurse Patient List</h1>
    </a>
</header>
<section class="mt-10">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <ul id="patientTabs" class="flex mb-8 text-center">
            <li class="mr-6 p-2">
                <a href="{{ route('nurse.view') }}" onclick="changeAdmissionType('all')">
                    All Patients
                </a>
            </li>
            <li class="mr-6 p-2">
                <a href="{{ route('nurse.view', ['admissionType' => 'inpatient']) }}" onclick="changeAdmissionType('inpatient')">
                    Inpatient
                </a>
            </li>
            <li class="mr-6 p-2">
                <a href="{{ route('nurse.view', ['admissionType' => 'outpatient']) }}" onclick="changeAdmissionType('outpatient')">
                    Outpatient
                </a>
            </li>
        </ul>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <a href="/nurse-patients/{{$patient->patient_id}}" class="bg-sky-600 text-white px-4 py-1 rounded">view</a>
                    </td>            
                </tr>
                @endforeach
