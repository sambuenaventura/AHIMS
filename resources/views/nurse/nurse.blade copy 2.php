                    ...
                    <h4 class="font-bold">Patients</h4>
                        ...
                        <form class="d-flex" action="{{ route('nurse.searchInpatient', ['admissionType' => 'inpatient']) }}" method="GET">
                         <div class="input-group mb-3">
                            <input class="form-control" type="search" placeholder="Search Inpatient Patients" aria-label="Search" name="inpatientSearch">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" type="search" placeholder="Search Outpatient Patients" aria-label="Search" name="outpatientSearch">
                            <input type="hidden" name="admissionType" value="{{ request('admissionType') }}">
                            <button class="btn btn-outline-success" type="submit">Search</button>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" type="search" placeholder="Search Archived Patients" aria-label="Search" name="archivedSearch">
                            <input type="hidden" name="admissionType" value="{{ request('admissionType') }}">
                            <button class="btn btn-outline-success" type="submit">Search</button>
                        </div>
                    </form>
