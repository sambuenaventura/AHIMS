        ...
        <div class="card pe-0 mb-4 shadow-md">
            <div class="card-body m-1">
                ...
                <form action="{{ route('nurse.requestLaboratoryServices', ['id' => $patient->patient_id]) }}" method="POST">
                    ...
                    <div class="modal fade" id="modalForLabRequests" tabindex="-1" aria-labelledby="modalForLabRequestsLabel" aria-hidden="true">
                                ...
                                <div class="modal-body m-3">
                                    <div class="modalContent">
                                        ...
                                        <div class="d-flex justify-content-evenly mt-5">
                                            ...
                                            <button type="button" class="btn btn-success ms-2 btn-custom-style btn-submit" data-bs-toggle="modal" data-bs-target="#modalForLabRequests2">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="modalForLabRequests2" tabindex="-1" aria-labelledby="modalForLabRequestsLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-body m-3">
                                    <div class="modalContent">
                ...
                <form action="{{ route('nurse.requestImagingServices', ['id' => $patient->patient_id]) }}" method="POST">
                    ...
                    <div class="form-group mb-3" id="xrayOptions" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Digits PA" id="DigitsPA" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="DigitsPA">Digits PA</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Hands PA/PA" id="HandsPA" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="HandsPA">Hands PA/PA</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Wrist PA/PA lateral" id="WristPA" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="WristPA">Wrist PA/PA lateral</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Carpal" id="Carpal" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Carpal">Carpal</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Forearm AP & lateral" id="Forearm" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Forearm">Forearm AP & lateral</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Elbow AP & lateral" id="Elbow" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Elbow">Elbow AP & lateral</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Humerus AP & lateral" id="Humerus" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Humerus">Humerus AP & lateral</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Shoulder" id="Shoulder" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Shoulder">Shoulder</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Scapula" id="Scapula" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Scapula">Scapula</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Clavicle AP" id="Clavicle" name="xray_tests[]" onchange="updateSenderMessage()">
                            ...
                            <div class="col-md-6">
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Sternum" id="Sternum" name="xray_tests[]" onchange="updateSenderMessage()">
                                    <label class="form-check-label" for="Sternum">Sternum</label>
                                </div>
                                <div class="form-check bg-light rounded-2 py-1">
                                    <input class="form-check-input" type="checkbox" value="Foot AP" id="Foot" name="xray_tests[]" onchange="updateSenderMessage()">
...
function showConfirmationModal() {
        // Show the modal
        var myModal = new bootstrap.Modal(document.getElementById('modalForLabRequests'), {
            keyboard: false
        });
        myModal.show();
}
...
document.getElementById('submitButton').addEventListener('click', function() {
    ...
    //         selectedTests.push(checkbox.value);
    //     });
    //     var senderMessage = selectedTests.join(', ');
    //     if (senderMessage.endsWith(', ')) {
    //         senderMessage = senderMessage.slice(0, -2); // Remove the last comma and space
    //     }
    //     document.getElementById('sender_message').value = senderMessage;
    // }
</script>
{{-- <script>
