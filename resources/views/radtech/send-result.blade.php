        ...
        <div class="card pe-0 mb-4 shadow-md">
            <div class="card-body m-2">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Upload Result</h4>
                </div>
                <!-- FORM -->
                <form action="{{ route('process.imaging') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="buttons mt-4 flex justify-content-end">
                        <div class="a-btn">
                            <a href="{{ route('radtech.requests') }}" class="btn btn-light btn-custom-style btn-cancel">Cancel</a>
                        </div>
