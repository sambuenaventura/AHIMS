      ...
      <div class="left">
        <div class="boxes">
          <div class="box box1 flex flex-col bg-custom-102">
            <p id="datePlaceholder" class="font-bold"></p>
        ...
        <div class="card pe-0">
            <div class="card-body m-1">
                ...
                <ul class="nav nav-underline overflow-x-auto">
                  ...
                  <li class="nav-item">
                      <a class="nav-link {{ request('specialty') == 'Internal_Medicine' ? 'active text-success' : 'text-secondary' }}" href="{{ route('admission.index', ['specialty' => 'Internal_Medicine']) }}">Internist</a>
                  </li>
