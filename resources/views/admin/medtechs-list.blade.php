        ...
        <div class="card pe-0">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Medical Technologists</h4>
                    <form class="d-flex" action="{{ route('admin.medtechsView') }}" method="GET">
                ...
                <table class="table table-striped mt-3 Add">
                  ...
                  <tbody>
                      ...
                      @empty
                      <tr>
                          <td colspan="7" class="text-center">No medical technologists found</td>
                      </tr>
                  @endforelse                     
                </tbody>
              </table>
              ...
              <div class="mt-4">
                {{ $medtechs->appends(['search' => request('search')])->links() }}
            </div>
