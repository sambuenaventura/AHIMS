...
<section id="admission">
    <div class="admission-content">
        <div class="card pe-0">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Register Physician</h4>
              {{-- </form> --}}
                                
                
                
                </div>
                <form action="{{ route('storeDoctor') }}" enctype="multipart/form-data" method="POST" class="flex flex-col">
                    @csrf
        ...
        <div class="card pe-0 mt-4">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Import Physicians</h4>
              {{-- </form> --}}
                                
                
                
                </div>
                <form action="{{ route('importDoctor') }}" enctype="multipart/form-data" method="POST" class="flex flex-col">
                    @csrf
                    <div class="hero-content">
                        <div class="row">
                            <div class="col">
