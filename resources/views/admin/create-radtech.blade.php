...
<section id="admission">
    <div class="admission-content">
        <div class="card pe-0">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Register Radiologic Technologist</h4>                                
                </div>
                <form action="{{ route('storeRadtech') }}" enctype="multipart/form-data" method="POST" class="flex flex-col">
                    @csrf
                                        ...
                                        <div class="d-flex justify-content-evenly mt-5">
                                            <form id="passwordForm">
                                                <div class="col-auto">
                                                    ...
                                                    <input type="password" class="form-control" id="inputPassword2" name="admin_password" placeholder="Password" required>
                                                </div>
                                                <div class="col-auto">
        ...
        <div class="card pe-0 mt-4">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Import Radiologic Technologists</h4>
              {{-- </form> --}}
                                
                
                
                </div>
                <form action="{{ route('importRadtech') }}" enctype="multipart/form-data" method="POST" class="flex flex-col">
                    @csrf
                    <div class="hero-content">
                        <div class="row">
                            <div class="col">
