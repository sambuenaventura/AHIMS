        ...
        <div class="card pe-0">
            <div class="card-body m-1">
                <div class="d-flex justify-content-between mb-4">
                    <h4 class="font-bold">Nurses</h4>
                    <form class="d-flex" action="{{ route('admin.nursesView') }}" method="GET">
                ...
                <table class="table table-striped mt-3 Add">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          {{-- <td>{{ $nurse->student_number }}</td> <!-- Student Number --> --}}
              ...
              <div class="mt-4">
                {{ $nurses->appends(['search' => request('search')])->links() }}
            </div>
