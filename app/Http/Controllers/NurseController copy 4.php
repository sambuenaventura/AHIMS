...
use App\Models\Request as ServiceRequest; // Import the Request model
...
public function archivePatient(Request $request, $patient_id)
{
    ...
    //         'sender_id' => 'required|exists:users,id', // Assuming sender_id is the authenticated user's ID
    //         'receiver_id' => 'required|exists:users,id',
    //         'procedure_type' => 'required',
    //         'message' => 'nullable|string',
    //         'image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048', // Adjust file size and allowed formats as needed
    //         'status' => 'nullable|string',
    //     ]);
    
    //     // Create a new Request instance using the validated data
    //     $serviceRequest = \App\Models\Request::create([
    //         'sender_id' => $validatedData['sender_id'],
    //         'receiver_id' => $validatedData['receiver_id'],
    //         'procedure_type' => $validatedData['procedure_type'],
    //         'message' => $validatedData['message'],
    //         'status' => $validatedData['status'],
    //     ]);
    
    //     // Optionally, you can upload and store the image file if provided
    //     if ($request->hasFile('image')) {
    //         $imagePath = $request->file('image')->store('lab_service_images', 'public');
    //         $serviceRequest->image = $imagePath;
    //         $serviceRequest->save();
    //     }
    
    //     // Redirect the user or return a response as needed
    //     return response()->json(['message' => 'Laboratory service request submitted successfully'], 200);
    // }
    ...
    public function requestLaboratoryServices(Request $request)
    {
        ...
        $serviceRequest->patient_name = $validatedData['patient_name'];
        ...
        return redirect()->back()->with('success', 'Laboratory service request submitted successfully');
    }
